...
// --- MPEG2 ---
struct huc_mpeg2_slice_data {
	uint32_t slice_data_address;
	uint32_t slice_data_size;
};

struct huc_mpeg2_slice_params {
	uint32_t slice_params_address;
	uint32_t slice_params_size;
};

// --- VC1 ---
struct huc_vc1_slice_data {
	uint32_t slice_data_address;
	uint32_t slice_data_size;
};

struct huc_vc1_slice_params {
	uint32_t slice_params_address;
	uint32_t slice_params_size;
};

// --- JPEG ---
struct huc_jpeg_slice_data {
	uint32_t slice_data_address;
	uint32_t slice_data_size;
};

struct huc_jpeg_slice_params {
	uint32_t slice_params_address;
	uint32_t slice_params_size;
};
